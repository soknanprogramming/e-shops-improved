                            ...
                            <div class="card-body">
                                ...
                                <div class="card-rating">
                                    <div class="stars" aria-hidden="true">
                                        ...
                                        for ($s = 1; $s <= 5; $s++):
                                            $filled = $s <= floor($avgRating);
                                            $half   = !$filled && ($s - 0.5) <= $avgRating;
                                        ?>
                                    ...
                                    <span class="rating-count">(<?php echo isset($product['rating_count']) && $product['rating_count'] > 0 ? $product['rating_count'] : 'No'; ?>)</span>
                                </div>
