-- New Table Schema (Generated from Repositories and Controllers)
-- Generated on: 2026-04-10

-- Create Database with Khmer support
CREATE DATABASE IF NOT EXISTS khmer245_db 
...
CREATE TABLE IF NOT EXISTS `User` (
    ...
    `avatar` BOOLEAN NOT NULL DEFAULT 0,
...
-- 6. Table: liked (Used for legacy Product reference)
...
-- 7. Table: comment (Used for legacy Product reference)
...
CREATE TABLE IF NOT EXISTS `Product` (
    ...
    `showed` BOOLEAN NOT NULL DEFAULT 1,
    ...
    FOREIGN KEY (`liked_id`) REFERENCES `liked`(`id`) ON DELETE CASCADE,
    FOREIGN KEY (`comment_id`) REFERENCES `comment`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- 9. Table: product_likes (Real-time likes)
...
-- 10. Table: product_comments (Real-time comments)
